...
/***/ function(module, exports, __webpack_require__) {
	...
	var uiSignActions = __webpack_require__(31);
	  ...
	  $('.result').on('click', function (e) {
	    ...
	    api.getOneSurvey(surveyId, function (survey) {
	      ...
	      api.allSurveyResponses(surveyId, function (answer) {
	        $('.dashboard-page').empty();
	        var responseTemplate = __webpack_require__(30);
	        $('.result-survey-page').html(responseTemplate({ answer: answer }));
	      });
	    });
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "      <tr data-results-id=\""
	    ...
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\"> Result</span>\n            </button>\n          </span>\n        </td>\n        <td>\n          <a href=\"http://squad-khanh-do.github.io/surveys/"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" target=\"_blank\">http://squad-khanh-do.github.io/surveys/"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "</a> <!-- http://take-a-vey.com/surveys/ -->\n        </td>\n        <td>\n          <span class=\"button-center\">\n            <button class=\"btn btn-xs btn-info update-button\" data-results-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
