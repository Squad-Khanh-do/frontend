...
/***/ function(module, exports, __webpack_require__) {
	...
	var uiSurveyActions = __webpack_require__(4);
	var uiSignActions = __webpack_require__(30);
	var myApp = __webpack_require__(6);
	...
	var signIn = function signIn(e) {
	  ...
	  $.ajax({
	    ...
	    processData: false,
	    data: formData
	  }).done(uiSignActions.inSuccess).fail(function (err) {
	    console.error(err);
	  });
	};
	...
	var signOut = function signOut(e) {
	  ...
	  }).done(uiSignActions.outSuccess).fail(function (err) {
	    console.error(err);
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var renderDash = function renderDash(survey) {
	  var dashTemplate = __webpack_require__(7);
	  $('.dashboard-page').html(dashTemplate({ survey: survey }));
	  uiDeleteSurvey();
	  uiUpdateSurvey();
	  uiResponseSurvey();
	  showResult();
	...
	var refreshDash = function refreshDash() {
	  $('.create-survey-page').empty();
	  $('.result-survey-page').empty();
	  api.retrieveSurveys(renderDash, log);
	};

	var displaySurveyType = function displaySurveyType(type, showItem, hideItem, optional) {
	...
	var createSurveyDisplay = function createSurveyDisplay() {
	...
	$('.survey-tab').on('click', function () {
	  var createTemplate = __webpack_require__(27);
	...
	var uiDeleteSurvey = function uiDeleteSurvey() {
	...
	var uiUpdateSurvey = function uiUpdateSurvey() {
	  $('.update-button').on('click', function (e) {
	    e.preventDefault();
	    var surveyId = $(this).attr('data-results-id');
	    api.getOneSurvey(surveyId, function (survey) {
	      var createSurveyTemplate = __webpack_require__(27);
	      $('.dashboard-page').empty();
	      $('.create-survey-page').html(createSurveyTemplate({ survey: survey }));
	      displaySurveyType('#multiple-choice', '.options', '.fill-in');
	      displaySurveyType('#text', '.fill-in', '.options', '.mc-answer');
	      $('.create-survey-submit').on('click', function () {
	...
	var displayResponseChoice = function displayResponseChoice(mcAnswer, options, text) {
	  if ($(mcAnswer).val() === '') {
	    $(options).hide();
	  } else {
	    $(text).hide();
	...
	var uiResponseSurvey = function uiResponseSurvey() {
	  $('.survey-link').on('click', function (e) {
	    e.preventDefault();
	    var surveyId = $(this).attr('data-results-id');
	    api.getOneSurvey(surveyId, function (survey) {
	      var responseTemplate = __webpack_require__(28);
	      $('.dashboard-page').empty();
	      $('.create-survey-page').html(responseTemplate({ survey: survey }));
	...
	var countResult = function countResult(arr, item) {
	  var obj = [];
	  var noCommaString = void 0;
	...
	var displayUniqueValues = function displayUniqueValues(arr, item) {
	  var uniqueNames = [];
	  $.each(countResult(arr, item), function (i, el) {
	    ...
	    $('.result-survey-page').empty();
	    for (var _i = 0; _i < uniqueNames.length; _i++) {
	      $('.result-survey-page').append(uniqueNames[_i] + '<br>');
	    }
	  });
	};
	...
	var showResult = function showResult() {
	  $('.result').on('click', function (e) {
	    ...
	    api.getOneSurvey(surveyId, function (survey) {
	      $('.dashboard-page').empty();
	      var resultTemplate = __webpack_require__(29);
	      $('.create-survey-page').html(resultTemplate({ survey: survey }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createSurvey = function createSurvey(formLocation, onSuccess, onFailure) {
	  event.preventDefault(); //createSurvey                 // Stops page Reload
	  var item = new FormData(document.querySelector(formLocation)); // document.querySelector('#createSurvey')  // object containing the FormData
	  $.ajax({
	...
	var getOneSurvey = function getOneSurvey(id, onSuccess, onFailure) {
	  $.ajax({
	...
	var retrieveSurveys = function retrieveSurveys(onSuccess, onFailure) {
	  $.ajax({
	    url: myApp.baseUrl + "/surveys",
	    method: 'GET',
	    headers: {
	...
	var updateSurvey = function updateSurvey(id, formLocation, onSuccess, onFailure) {
	  event.preventDefault(); //createSurvey                 // Stops page Reload
	  var item = new FormData(document.querySelector(formLocation)); // document.querySelector('#createSurvey')  // object containing the FormData
	  $.ajax({
	    url: myApp.baseUrl + '/surveys/' + id,
	...
	var deleteSurvey = function deleteSurvey(id, onSuccess, onFailure) {
	  $.ajax({
	    url: myApp.baseUrl + "/surveys/" + id,
	    method: 'DELETE',
	    headers: {
	...
	var postResponse = function postResponse(id, formLocation, onSuccess, onFailure) {
	  event.preventDefault(); //
	  var item = new FormData(document.querySelector(formLocation)); // object containing the FormData
	  $.ajax({
	...
	var allSurveyResponses = function allSurveyResponses(id, onSuccess, onFailure) {
	  $.ajax({
	    url: myApp.baseUrl + '/surveys/' + id + '/surveyResponses',
	    method: 'GET',
	    headers: {
	...
	module.exports = {
	  ...
	  retrieveSurveys: retrieveSurveys,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "      <tr data-results-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n        <td><a class=\"survey-link\" data-results-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">"
	    + alias2(alias1((depth0 != null ? depth0.title : depth0), depth0))
	    + "</a></td>\n        <td>\n"
	    + ((stack1 = helpers.blockHelperMissing.call(depth0,alias1((depth0 != null ? depth0.questions : depth0), depth0),{"name":"this.questions","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "        </td>\n        <td>\n          <span class=\"button-center\">\n            <button class=\"btn btn-xs btn-info\">\n              <span class=\"result\" data-results-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\"> Result</span>\n            </button>\n          </span>\n        </td>\n        <td>\n          <span class=\"button-center\">\n            <button class=\"btn btn-xs btn-info update-button\" data-results-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n              <span> UPDATE</span>\n            </button>\n            <button class=\"btn btn-xs btn-warning delete-button\" data-results-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n              <span> DELETE</span>\n            </button>\n          </span>\n        </td>\n      </tr>\n";
	  ...
	  return "<h2 class=\"survey-title\">Survey Dashboard</h2>\n\n<form class=\"dashboardtable\">\n  <table class=\"table table-bordered\">\n    <thead>\n      <tr>\n        <th>Survey</th>\n        <th>Question</th>\n        <th>Result</th> <!-- result buttons -->\n        <th>CRUD IT</th>\n      </tr>\n    </thead>\n    <tbody id=\"result-list\">\n"
	    + ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.surveys : stack1), depth0),{"name":"survey.surveys","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "      </script>\n    </tbody>\n  </table>\n</form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.questions : depth0), depth0),{"name":"this.questions","hash":{},"fn":container.program(9, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"9":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.choice : depth0), depth0),{"name":"this.choice","hash":{},"fn":container.program(10, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"10":function(container,depth0,helpers,partials,data) {
	    return "          "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.questone : depth0), depth0))
	    + "\n";
	},"12":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.questions : depth0), depth0),{"name":"this.questions","hash":{},"fn":container.program(13, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"13":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.choice : depth0), depth0),{"name":"this.choice","hash":{},"fn":container.program(14, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"14":function(container,depth0,helpers,partials,data) {
	    return "          "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.questtwo : depth0), depth0))
	    + "\n";
	},"16":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.questions : depth0), depth0),{"name":"this.questions","hash":{},"fn":container.program(17, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"17":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.choice : depth0), depth0),{"name":"this.choice","hash":{},"fn":container.program(18, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"18":function(container,depth0,helpers,partials,data) {
	    return "            "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.questthree : depth0), depth0))
	    + "\n";
	},"20":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.questions : depth0), depth0),{"name":"this.questions","hash":{},"fn":container.program(21, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"21":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.choice : depth0), depth0),{"name":"this.choice","hash":{},"fn":container.program(22, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"22":function(container,depth0,helpers,partials,data) {
	    return "          "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.questfour : depth0), depth0))
	    + "\n";
	},"24":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.questions : depth0), depth0),{"name":"this.questions","hash":{},"fn":container.program(25, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"25":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.choice : depth0), depth0),{"name":"this.choice","hash":{},"fn":container.program(26, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"26":function(container,depth0,helpers,partials,data) {
	    return "          "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.questfive : depth0), depth0))
	    + "\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, alias1=container.lambda, alias2=helpers.blockHelperMissing;

	  return "<h2 class=\"survey-title\">Make A'Vey</h2>\n<form class=\"form-basic\" id='createSurvey'>\n\n  <div class=\"form-row\">\n    <label>\n      <span>Survey Title</span>\n      <textarea name=\"survey[title]\">\n"
	    ...
	    + "      </textarea>\n    </label>\n  </div>\n\n  <div class=\"form-row\">\n    <label>\n      <span>Description Text </span>\n      <textarea name=\"survey[description]\">\n"
	    ...
	    + "      </textarea>\n    </label>\n  </div>\n\n  <div class=\"form-row\">\n    <label>\n      <span>Survey Question</span>\n      <textarea name=\"survey[questions][text]\">\n"
	    ...
	    + "      </textarea>\n    </label>\n  </div>\n\n<h5>Please choose which survey type you want<h5>\n\n  <div class=\"btn-group survey-type\">\n    <button type=\"button\" class=\"btn btn-info dropdown-toggle\"  data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">\n      Survey Type <span class=\"caret\"></span>\n    </button>\n    <ul class=\"dropdown-menu\" >\n      <li><a id=\"multiple-choice\">Multiple Choice</a></li>\n        <li role=\"separator\" class=\"divider\"></li>\n      <li><a id=\"text\">Text</a></li>\n    </ul>\n  </div>\n\n  <br>\n  <br>\n\n<div class = \"options\">\n  <div class=\"form-row\">\n    <label>\n      <span>Choice one</span>\n      <textarea class=\"mc-answer\" name=\"survey[questions][choice][questone]\">\n"
	    + ((stack1 = alias2.call(depth0,alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.survey : stack1), depth0),{"name":"survey.survey","hash":{},"fn":container.program(8, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "      </textarea>\n    </label>\n  </div>\n\n  <div class=\"form-row\">\n    <label>\n      <span>Choice two</span>\n      <textarea class=\"mc-answer\" name=\"survey[questions][choice][questtwo]\">\n"
	    + ((stack1 = alias2.call(depth0,alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.survey : stack1), depth0),{"name":"survey.survey","hash":{},"fn":container.program(12, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "      </textarea>\n    </label>\n  </div>\n\n  <div class=\"form-row\">\n    <label>\n      <span>Choice three</span>\n      <textarea class=\"mc-answer\" name=\"survey[questions][choice][questthree]\">\n"
	    + ((stack1 = alias2.call(depth0,alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.survey : stack1), depth0),{"name":"survey.survey","hash":{},"fn":container.program(16, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "      </textarea>\n    </label>\n  </div>\n\n  <div class=\"form-row\">\n    <label>\n      <span>Choice four</span>\n      <textarea class=\"mc-answer\" name=\"survey[questions][choice][questfour]\">\n"
	    + ((stack1 = alias2.call(depth0,alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.survey : stack1), depth0),{"name":"survey.survey","hash":{},"fn":container.program(20, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "      </textarea>\n    </label>\n  </div>\n\n  <div class=\"form-row\">\n    <label>\n      <span>Choice five</span>\n      <textarea class=\"mc-answer\" name=\"survey[questions][choice][questfive]\">\n"
	    + ((stack1 = alias2.call(depth0,alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.survey : stack1), depth0),{"name":"survey.survey","hash":{},"fn":container.program(24, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "      </textarea>\n    </label>\n  </div>\n</div>\n\n<p class = \"fill-in\"> There will be a text field for survey takers to fill in.</p>\n\n  <div class=\"form-row\">\n    <button type=\"submit\" class=\"btn btn-info create-survey-submit\">Take It A'vey!</button>\n  </div>\n\n</form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n  <div class=\"survey-response-adjust\">\n    <div class=\"form-row\">\n      <label>\n        <span>Survey Title</span>\n        <p class=\"right-side\" name=\"survey[title]\">\n          "
	    + alias2(alias1((depth0 != null ? depth0.title : depth0), depth0))
	    + "\n        </p>\n      </label>\n    </div>\n\n    <div class=\"form-row\">\n      <label>\n        <span>Description Text </span>\n        <p class=\"right-side\" name=\"survey[description]\">\n          "
	    + alias2(alias1((depth0 != null ? depth0.description : depth0), depth0))
	    + "\n        </p>\n      </label>\n    </div>\n\n    <div class=\"form-row\">\n      <label>\n        <span>Survey Question</span>\n        <p class=\"right-side\" name=\"survey[questions][text]\">\n"
	    + ((stack1 = alias3.call(depth0,alias1((depth0 != null ? depth0.questions : depth0), depth0),{"name":"this.questions","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "        </p>\n      </label>\n    </div>\n\n    <div class=\"form-row answer-text\">\n      <label>\n        <span>Answer Text </span>\n        <textarea name=\"surveyResponse[response]\"></textarea>\n      </label>\n    </div>\n\n  </div>\n\n\n  <div class = \"options-answer\">\n"
	    + ((stack1 = alias3.call(depth0,alias1((depth0 != null ? depth0.questions : depth0), depth0),{"name":"this.questions","hash":{},"fn":container.program(4, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "  </div>\n\n  <div class=\"form-row\">\n    <button type=\"submit\" class=\"btn btn-info response-submit\">Take It A'vey!</button>\n  </div>\n";
	},"2":function(container,depth0,helpers,partials,data) {
	    return "          "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.text : depth0), depth0))
	    + "\n";
	  ...
	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.choice : depth0), depth0),{"name":"this.choice","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"5":function(container,depth0,helpers,partials,data) {
	    var alias1=container.lambda, alias2=container.escapeExpression;

	  return "    <div class=\"radio\">\n      <label><input type=\"radio\" class=\"mc-ans\" name=\"surveyResponse[response]\" value=\""
	    + alias2(alias1((depth0 != null ? depth0.questone : depth0), depth0))
	    + "\">\n        &ensp;"
	    + alias2(alias1((depth0 != null ? depth0.questone : depth0), depth0))
	    + "\n      </label>\n\n    </div>\n\n    <div class=\"radio\">\n      <label><input type=\"radio\" class=\"mc-ans\" name=\"surveyResponse[response]\" value=\""
	    + alias2(alias1((depth0 != null ? depth0.questtwo : depth0), depth0))
	    + "\">\n        &ensp;"
	    + alias2(alias1((depth0 != null ? depth0.questtwo : depth0), depth0))
	    + "\n      </label>\n    </div>\n\n    <div class=\"radio\">\n      <label><input type=\"radio\" class=\"mc-ans\" name=\"surveyResponse[response]\" value=\""
	    + alias2(alias1((depth0 != null ? depth0.questthree : depth0), depth0))
	    + "\" >\n        &ensp;"
	    + alias2(alias1((depth0 != null ? depth0.questthree : depth0), depth0))
	    + "\n      </label>\n    </div>\n\n    <div class=\"radio\">\n      <label><input type=\"radio\" class=\"mc-ans\" name=\"surveyResponse[response]\" value=\""
	    + alias2(alias1((depth0 != null ? depth0.questfour : depth0), depth0))
	    + "\" >\n        &ensp;"
	    + alias2(alias1((depth0 != null ? depth0.questfour : depth0), depth0))
	    + "\n      </label>\n    </div>\n\n    <div class=\"radio\">\n      <label><input type=\"radio\" class=\"mc-ans\" name=\"surveyResponse[response]\" value=\""
	    + alias2(alias1((depth0 != null ? depth0.questfive : depth0), depth0))
	    + "\">\n        &ensp;"
	    + alias2(alias1((depth0 != null ? depth0.questfive : depth0), depth0))
	    + "\n      </label>\n    </div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h2 class=\"survey-title\">Answer A'vey</h2>\n<form class=\"form-basic\" id='responseSurvey'>\n"
	    + ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.survey : stack1), depth0),{"name":"survey.survey","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var myApp = __webpack_require__(6);
	var uiSign = __webpack_require__(4);
	...
	var inSuccess = function inSuccess(data) {
	...
	var outSuccess = function outSuccess() {
	  $('.left-nav').hide();
	  hideUser();
	  $('.loggedin-ui').hide();
	  $('.change-password-nav').hide();
